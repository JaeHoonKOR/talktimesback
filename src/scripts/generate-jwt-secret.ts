...
import { ensureAllSecrets, generateJWTSecret } from '../utils/jwt-secret-generator';
...
`);
  ...
  private static generateOnly(length: number): void {
  ...
  private static generateAndSave(length: number): void {
    try {
